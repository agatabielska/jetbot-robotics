"""Copy of PUT_jetbot/src/PUTDriver.py. We keep the public API identical so evaluators
can swap the model without touching the driver. max_speed / max_steering / differential
are configurable via config.yml (set by calibrate.py)."""
...
class PUTDriver:
    ...
    def stop(self):
        self.robot.set_motors(left_speed=0.0, right_speed=0.0)
